...
namespace BlazorSurf.Server.Data.Migrations
{
    ...
    [Migration("20221213094504_chatmodels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorSurf.Shared.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BlazorSurf.Shared.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BlazorSurf.Shared.ChatMessage", b =>
                {
                    b.HasOne("BlazorSurf.Shared.ApplicationUser", "FromUser")
                        .WithMany("ChatMessagesFromUsers")
                        .HasForeignKey("FromUserId")
                        .IsRequired();

                    b.HasOne("BlazorSurf.Shared.ApplicationUser", "ToUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazorSurf.Shared.ApplicationUser", null)
                        .WithMany()
